              ...
              <div className="col-lg-3 col-md-6">
                <div className="connect-with">
                  ...
                  <ul className="social-media">
                    <li>
                      <a href="#">
                        <FaFacebook color="#fbc509" size={40} />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <AiFillTwitterCircle color="#fbc509" size={45} />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <AiFillTikTok color="#fbc509" size={45} />
                      </a>
                    </li>
                  </ul>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="widget-title">
                ...
                <p>
                  ...
                  connected to their faith in their everyday lives.
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="Information widget-title">
                ...
                <div className="contact-info">
                  ...
                  <h5>Asokore Mampong, Buobai Central Mosque Kumasi, Ghana</h5>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
