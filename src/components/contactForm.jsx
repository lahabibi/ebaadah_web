...
import logo from "../assets/images/__logo.png";
...
export default function ContactForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://api.kingsperpmining.com/api/contact", {
        method: "POST",
        headers: {
  ...
  return (
    <>
      <section className=" our-courses" style={{ marginTop: "20px" }}>
        <div className="container">
          <div className="heading">
            <img src={logo} alt="ebaadah logo" height={80} width={80} />
            <p>Reach Out To Us.</p>
          ...
          <div className="row">
            ...
            <div className="col-lg-4">
              ...
              >
                <div>
                  <h4>Phone No:</h4>
                  <a href="#">+233 (0) 545-822-539</a>
                  <a href="#">+233 (0) 534-857-403</a>
                </div>
                <i>
                  <svg
                    viewBox="0 0 64 64"
              ...
              >
                <div>
                  <h4>Email Address:</h4>
                  <a href="mailto:info@ebaadah.com">info@ebaadah.com</a>
                  <a href="mailto:info@ebaadah.com">info@ebaadah.com</a>
                </div>
                <i>
                  <svg
          ...
          <div className="map">
            <iframe
              src="https://www.google.com/maps?q=6.6885,-1.6244&z=15&output=embed"
              loading="lazy"
